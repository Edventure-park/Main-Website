          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
            {cultureValues.slice(0, 3).map((value, index) => (
              <div key={index} className="group relative cursor-target">
                ...
                {/* Rectangular Card */}
                <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${value.color} p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:scale-110 group-hover:-rotate-1 transform-gpu`}>
                  {/* Content with Enhanced Typography */}
                  <div className="relative text-center">
                    <p className="text-xl font-black text-white drop-shadow-lg md:text-2xl leading-tight">
                      {value.text}
                    </p>
                  </div>
                </div>
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-2xl">
              <div className="group relative cursor-target">
                ...
                {/* Rectangular Card */}
                <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${cultureValues[3].color} p-12 shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:scale-105 transform-gpu`}>
                  {/* Content with Enhanced Typography */}
                  <div className="relative text-center">
                    <p className="text-2xl font-black text-white drop-shadow-lg md:text-3xl leading-tight">
