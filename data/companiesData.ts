...
const mockCompanies: Company[] = [
  ...
  },
  {
    id: '174',
    name: 'MagicWard',
    description: 'Magical protection and security solutions for modern businesses.',
    cohort: 'A23',
    industry: ['Security', 'Technology'],
    logoUrl: '/assets/logos/magicward.png',
  },
  {
    id: '175',
    name: 'MerakiRana',
    description: 'Passionate culinary experiences with a creative twist.',
    cohort: 'A23',
    industry: ['Food & Beverage', 'Hospitality'],
    logoUrl: '/assets/logos/merakirana.png',
  },
  {
    id: '176',
    name: 'FreshLaban',
    description: 'Fresh dairy products delivered straight from farm to table.',
    cohort: 'A23',
    industry: ['Food & Beverage', 'Agriculture'],
    logoUrl: '/assets/logos/freahlaban.png',
  },
  {
    id: '177',
    name: 'Leeza',
    description: 'Elegant lifestyle products for the modern consumer.',
    cohort: 'A23',
    industry: ['Lifestyle', 'Consumer Goods'],
    logoUrl: '/assets/logos/leeza.png',
  },
  {
    id: '178',
    name: 'Ministry of Cheese',
    description: 'Artisanal cheese products and gourmet dairy delights.',
    cohort: 'A23',
    industry: ['Food & Beverage', 'Gourmet'],
    logoUrl: '/assets/logos/ministryofcheese.png',
  },
  {
    id: '179',
    name: 'Student Union',
    description: 'Connecting students with opportunities and resources for academic success.',
    cohort: 'A23',
    industry: ['EdTech', 'Community'],
    logoUrl: '/assets/logos/studentunion.png',
  },
  {
    id: '180',
    name: 'Younani',
    description: 'Innovative health and wellness solutions for the younger generation.',
    cohort: 'A23',
    industry: ['HealthTech', 'Wellness'],
    logoUrl: '/assets/logos/younani.png',
  },
  {
    id: '181',
    name: 'Ministry of Games',
    description: 'Creating immersive gaming experiences and entertainment solutions.',
    cohort: 'A23',
    industry: ['Gaming', 'Entertainment'],
    logoUrl: '/assets/logos/ministryofgames.png',
  },
  {
    id: '182',
    name: 'FactHunter',
    description: 'Research and fact-checking platform for reliable information.',
    cohort: 'A23',
    industry: ['Media', 'Information'],
    logoUrl: '/assets/logos/facthunter.png',
  },
  {
    id: '183',
    name: 'Wild Wild Ventures',
    description: 'Bold investment strategies for adventurous entrepreneurs.',
    cohort: 'A23',
    industry: ['Venture Capital', 'Investment'],
    logoUrl: '/assets/logos/wildwildventures.png',
  },
  {
    id: '184',
    name: 'ARM Creatives',
    description: 'Full-service creative agency for branding and digital marketing.',
    cohort: 'A23',
    industry: ['Marketing', 'Creative'],
    logoUrl: '/assets/logos/armcreatives.png',
  },
  {
    id: '185',
    name: 'Sweetopia',
    description: 'Premium confectionery and sweet treats for every occasion.',
    cohort: 'A23',
    industry: ['Food & Beverage', 'Confectionery'],
    logoUrl: '/assets/logos/sweetopia.png',
  },
  {
    id: '186',
    name: 'Eventy',
    ...
    cohort: 'A23',
    industry: ['Events', 'SaaS'],
    logoUrl: '/assets/logos/eventy.png',
  },
  {
    id: '187',
    name: 'CampusLead',
    description: 'Leadership development programs for university students.',
    cohort: 'A23',
    industry: ['EdTech', 'Leadership'],
    logoUrl: '/assets/logos/campuslead.png',
  },
  {
    id: '188',
    name: 'ParkingGo',
    description: 'Smart parking solutions for urban mobility and convenience.',
    cohort: 'A23',
    industry: ['Smart City', 'Mobility'],
    logoUrl: '/assets/logos/parkinggo.png',
  },
  {
    id: '189',
    name: 'Adilogram',
    description: 'Social platform for sharing and discovering creative content.',
    cohort: 'A23',
    industry: ['Social Media', 'Creative'],
    logoUrl: '/assets/logos/adilogram.png',
  },
  {
    id: '190',
    name: 'Sportopia',
    description: 'Complete sports ecosystem for athletes and sports enthusiasts.',
    cohort: 'A23',
    industry: ['Sports', 'Fitness'],
    logoUrl: '/assets/logos/sportopia.png',
  },
  {
    id: '191',
    name: 'JustDesign',
    description: 'Affordable and accessible design services for everyone.',
    cohort: 'A23',
    industry: ['Design', 'Services'],
    logoUrl: '/assets/logos/justdesign.png',
  },
  {
    id: '192',
    name: 'PhiBuds',
    description: 'Friendship and social networking app for meaningful connections.',
    cohort: 'A20',
    industry: ['Social', 'Community'],
    logoUrl: '/assets/logos/phibuds.png',
  },
  // Missing companies from the provided list
  {
    id: '193',
    name: 'Spodit',
    description: 'Innovative sports and wellness platform.',
    cohort: 'A20',
  ...
  {
    id: '194',
    name: 'The Cast Reusable Road',
    description: 'Sustainable road construction using reusable materials.',
    cohort: 'A20',
    industry: ['Construction', 'Sustainability'],
    logoUrl: '/assets/EVP_logo.png',
  },
  {
    id: '195',
    name: 'PaloAlto Ventures',
    description: 'Venture capital and investment solutions.',
    cohort: 'A20',
    industry: ['Venture Capital', 'Investment'],
    logoUrl: '/assets/EVP_logo.png',
  },
  {
    ...
    description: 'Automotive industry events and exhibitions.',
    cohort: 'A20',
  ...
  },
  {
    id: '198',
    name: 'Pods',
    description: 'Modern transportation and mobility solutions.',
    cohort: 'A20',
  ...
  },
  {
    id: '199',
    name: 'Safaai',
    description: 'Cleaning and sanitation services for urban areas.',
    cohort: 'A20',
    industry: ['Services', 'Sanitation'],
    logoUrl: '/assets/EVP_logo.png',
  },
  {
    id: '200',
  ...
  },
  {
    id: '202',
    name: 'Kiddlowrld',
    description: 'Educational platform for children and kids.',
    cohort: 'A20',
    industry: ['Education', 'Children'],
    logoUrl: '/assets/EVP_logo.png',
  },
  ...
  },
  {
    id: '205',
    name: 'Ubuntu',
    description: 'Community-driven technology solutions.',
    cohort: 'A21',
  ...
  },
  {
    id: '207',
    name: 'OFAS',
    description: 'Office automation and management solutions.',
    cohort: 'A21',
    industry: ['SaaS', 'Office Automation'],
    logoUrl: '/assets/logos/ofas.png',
  },
  {
    id: '208',
    name: 'Hardware Incubator',
    description: 'Hardware startup incubation and support.',
    cohort: 'C21',
    industry: ['Hardware', 'Incubation'],
    logoUrl: '/assets/EVP_logo.png',
  },
  {
    id: '209',
    name: 'Code For India',
    description: 'Coding and software development for social impact.',
    cohort: 'C21',
  ...
  },
  {
    id: '210',
    name: 'Nutrish',
    description: 'Nutrition and healthy food delivery.',
    cohort: 'A22',
    industry: ['Food Delivery', 'Health'],
    logoUrl: '/assets/logos/nutrish.png',
  },
  {
    id: '211',
    name: 'AdAnalytics',
    description: 'Advanced analytics for advertising and marketing.',
    cohort: 'B22',
  ...
  },
  {
    id: '214',
    name: 'Altered Path',
    description: 'Alternative career and education pathways.',
    cohort: 'B22',
    industry: ['Education', 'Career'],
    logoUrl: '/assets/EVP_logo.png',
  },
  {
    id: '215',
    name: 'Elysian',
    description: 'Premium lifestyle and wellness products.',
    cohort: 'A23',
  ...
  },
  {
    id: '216',
    name: 'Bareoelements',
    description: 'Minimalist design and essential products.',
    cohort: 'A23',
    industry: ['Design', 'Consumer Goods'],
    logoUrl: '/assets/EVP_logo.png',
  },
  {
    id: '217',
    name: 'Adoro Baby',
    description: 'Premium baby care and parenting products.',
    cohort: 'A23',
    industry: ['Baby Care', 'E-commerce'],
    logoUrl: '/assets/EVP_logo.png',
  },
  {
    id: '218',
    name: 'Funfinance',
    description: 'Gamified financial education and literacy.',
    cohort: 'A23',
